                ...
                <div className="glass-card p-8 space-y-6">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div className="space-y-2">
                            <label className="text-xs font-semibold tracking-wider text-muted-foreground/80">Email (Use: admin@mail.com)</label>
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-semibold tracking-wider text-muted-foreground/80">Password (Use: admin123)</label>
                            <div className="relative">
